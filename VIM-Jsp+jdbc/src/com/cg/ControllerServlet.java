...
public class ControllerServlet extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else if(SAVE_CAR_ACTION.equals(actionName))
        {
			...
			//Set the destination page to carList.jsp
			System.out.println("inside SaveCar...");
        	CarDTO car=new CarDTO();
        ...
        /*	}
        	...
        	ArrayList<CarDTO> foundcars=(ArrayList<CarDTO>) carDAO.findAll();
        	System.out.println("foundcar"+foundcars);
        	request.setAttribute("carList",foundcars);
        	System.out.println("savecars"+foundcars);
        	destinationPage="carList.jsp";
