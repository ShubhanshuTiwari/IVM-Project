...
public class ServiceLocator {
    ...
    public static DataSource getDataSource(String dataSourceJndiName) throws ServiceLocatorException {
        ...
        try {
            ...
            System.out.println("Inside service locator data source jndi name"+(dataSourceJndiName));
            ...
            System.out.println("Service locator envContext.lookup"+envContext.lookup(dataSourceJndiName));
        ...
        System.out.println("At the last service locator data source"+dataSource);
		return dataSource;
