...
<body>
	...
	<p>
		<a href="controller?action=addCar">[Add Car]</a>
	</p>
	...
	<form name="deleteForm" method="post" action="controller">
		...
		<table>
			<tr>
				<th><a href="javascript:checkAll(document.deleteForm.id)">Select
						All</a></th>
				<th>Action</th>
				<th>Make</th>
				<th>Model</th>
			...
			<tr>
				<td colspan="5"><input type="submit" name="Delete Checked"
					value="Delete Checked" /> &nbsp;&nbsp; <input type="reset"
